...
public class ${modelName}Controller {
    ...
    */
    ...
    public View<Pages${left}${modelName}ListVO${right}> list(${modelName}ListDTO ${modelName?uncap_first}ListDTO,PageDTO<${modelName}> pageDTO) throws MxException {
    ...
    */
    ...
    //@SaCheckRole(value = {角色名})
    //@SaCheckPermission(value = 权限名)
    public Result create(@Validated ${modelName}DTO ${modelName?uncap_first}DTO) throws MxException {
    ...
    */
    ...
    //@SaCheckRole(value = {角色名})
    //@SaCheckPermission(value = 权限名)
    public Result update(<#if (isCreateSwagger)>@ApiParam(name = "id", value = "ID", required = true)</#if> @PathVariable String id,
    ...
    */
    ...
    //@SaCheckRole(value = {角色名})
    //@SaCheckPermission(value = 权限名)
    public View<${modelName}VO> detail(<#if (isCreateSwagger)>@ApiParam(name = "id", value = "ID", required = true)</#if> @PathVariable String id) throws MxException {
    ...
    */
    ...
    //@SaCheckRole(value = {角色名})
    //@SaCheckPermission(value = 权限名)
    public Result delete(<#if (isCreateSwagger)>@ApiParam(name = "ids", value = "ids", required = true)</#if> @NotNull(message = "ids不能为空") @RequestParam("ids[]") String[] ids) throws MxException {

...
public class SecurityRoleController {
    ...
    public MxView<Pages<SecurityRoleListVO>> list(@ApiParam(name = "name", value = "角色名称") String name,
    ...
    public MxResult create(@Validated SecurityRoleDTO roleDTO) throws MxException {
    ...
    public MxView<SecurityRoleVO> detail(@ApiParam(name = "id", value = "ID", required = true)
    ...
    public MxResult delete(@ApiParam(name = "ids", value = "ids", required = true)
    ...
    public MxResult permissionList(@ApiParam(name = "id", value = "id", required = true)
    ...
    public MxResult permissionBind(@ApiParam(name = "id", value = "id", required = true)

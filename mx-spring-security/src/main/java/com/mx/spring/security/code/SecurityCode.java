...
public enum SecurityCode {
    ...
    SECURITY_USER_PASSWORD_NOT_SAME(70003, "两次密码输入不一致"),
    SECURITY_USER_OLD_PASSWORD_ERROR(70004, "原密码错误"),
    SECURITY_USER_NEW_PASSWORD_NOT_SAME_OLD_PASSWORD(70005, "新密码不能和原密码相同"),
    SECURITY_USER_ROLE_EXISTS(70006, "该角色已经添加过了"),

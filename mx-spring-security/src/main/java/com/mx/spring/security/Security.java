...
public class Security {
    ...
    private static void permissionSql(List<String> sqlList, String dbName, String client, String userId) {
        ...
        LPConfig.permissionList().forEach(permission -> sqlList.add(StrUtil.format(sql, dbName, IdUtil.fastSimpleUUID(), client, permission.getGroupName(), permission.getName(), permission.getCode(), userId, time, userId, time)));
    }

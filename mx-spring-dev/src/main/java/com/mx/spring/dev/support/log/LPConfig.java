...
import static com.mx.spring.dev.support.log.LPConfig.GroupEnum.LOG;
...
public class LPConfig {
    ...
    static {
        //日志管理
        permissionList.add(new Permission(LOG.value(), PermissionEnum.LOG_LIST.value(), PermissionEnum.LOG_LIST.name()));
        permissionList.add(new Permission(LOG.value(), PermissionEnum.LOG_DELETE.value(), PermissionEnum.LOG_DELETE.name()));
    }
